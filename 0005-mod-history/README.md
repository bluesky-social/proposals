...
History would be relatively truncated/redacted. All reports and appeals by the current account would display. Any major public actions would be displayed (takedown, un-takedown, suspend, label). Ozone-private content would *definitely* not display (internal moderator comments, internal moderator tags), and the individual moderator account involved would *definitely* not be revealed. "Escalation" action would probably not display; "needs review" and "escalated" would probably look the same? In the future, it might be beneficial to indicate if an action taken was automated (eg, automod, auto-labeling).
